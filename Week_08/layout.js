...
function layout(element) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        if (itemStyle.flex) {
            flexLine.push(item);
        } else if (itemStyle.flexWrap === "nowrap" && isAutoManSize) {
            mainSpace -= itemStyle[mainSize];
            if (item[crossSize] !== null && itemStyle[crossSize] !== (void 0)) {
    ...
    if (style.flexWrap === 'nowrap' || isAutoManSize) {
    ...
    }
    {
        ...
        flexLines.forEach(function (items) {
            ...
            for (let i = 0; i < items.length; i++) {
                ...
                if (align === "center") {
                    itemStyle[crossStart] = crossBase + crossSign * (lineCrossSize - itemStyle) / 2;
                    itemStyle[crossEnd] = itemStyle[crossStart] + crossSign * itemStyle[crossSize];
                }
